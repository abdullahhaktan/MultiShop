...
namespace MultiShop.Discount.Services
{
    public class DiscountCouponService : IDiscountCouponService
    {
        ...
        {
            string query = "Delete From DiscountCoupons Where DiscountCouponId = @couponId";
            var parameters = new DynamicParameters();
        ...
        public async Task<GetDiscountCouponByIdDto> GetDiscountCouponByIdAsync(int discountDiscountCouponId)
        {
            string query = "Select * From DiscountCoupons Where DiscountCouponId = @couponId";
            var parameters = new DynamicParameters();
            parameters.Add("@couponId", discountDiscountCouponId);
            using (var connection = _context.CreateConnection())
            {
        ...
        {
            var query = "Update DiscountCoupons set Code=@code , Rate=@rate, IsActive=@isActive, ValidDate=@validDate Where DiscountCouponId=@couponId";

            var parameters = new DynamicParameters();
            parameters.Add("@couponId", updateDiscountCouponDto.DiscountCouponId);
